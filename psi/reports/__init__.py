...
from corehq.apps.reports.basic import BasicTabularReport, Column, FunctionView, SummingTabularMixin
...
class PSIReport(SummingTabularMixin, CustomProjectReport, DatespanMixin):
    update_after = True
